...
class Camera
{
  Camera()
  {
    position      = new PVector( 10, 170, 125 ); // initial position
    theta         = -1.2163571; // rotation around Y axis. Starts with forward direction as ( 0, 0, -1 )
    phi           = -0.46375504; // rotation around X axis. Starts with up direction as ( 0, 1, 0 )
    moveSpeed     = 50;
